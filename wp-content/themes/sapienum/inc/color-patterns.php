 ...
 */
function sapienum_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Sapienum default saturation level.
	 *
	 * @since Sapienum 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'sapienum_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.sapienum-front-page) .entry-title,
...
.colors-custom .sapienum-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.sapienum-front-page .panel-content .recent-posts article,
...
.colors-custom.sapienum-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Sapienum custom colors CSS.
	 *
	 * @since Sapienum 1.0
	 *
	 ...
	 */
	return apply_filters( 'sapienum_custom_colors_css', $css, $hue, $saturation );
}
