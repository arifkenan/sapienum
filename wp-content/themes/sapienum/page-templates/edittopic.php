...
<form class="ewrapper" id="commentform" method="post" >
  ...
  <br>
 <?php  $postData = get_post($_REQUEST['topicid']);  ?>
  <textarea class="editable" id="comment" name="comment" cols="45" rows="8" maxlength="65525" aria-required="true" required="required" placeholder="Type something...." required ><?php echo $postData->post_content; ?></textarea>
